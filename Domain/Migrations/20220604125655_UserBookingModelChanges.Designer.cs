...
namespace Domain.Migrations
{
    ...
    [Migration("20220604125655_UserBookingModelChanges")]
    partial class UserBookingModelChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entity.UserBookings", b =>
                {
                    ...
                    b.Property<int>("ResturantTableID")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.Entity.Resturant", b =>
                {
                    b.HasOne("Domain.Entity.ResturantOwner", "Owner")
                        .WithMany("Resturants")
